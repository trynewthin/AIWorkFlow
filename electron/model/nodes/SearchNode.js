/**
 * @file electron/model/nodes/SearchNode.js
...
const { Status } = require('../../config/nodes/nodeConfigs'); // 导入 Status
...
class SearchNode extends BaseNode {
   ...
   * @description 执行检索：基于 Pipeline 流处理嵌入向量并生成搜索结果
   * @param {Pipeline} pipeline - 输入的 Pipeline 实例, 期望包含 DataType.EMBEDDING
